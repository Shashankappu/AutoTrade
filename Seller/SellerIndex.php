  ...
  <head>
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li><a href="SellerIndex.php" class="active">Home</a></li>
                            ...
                            <li class="dropdown">
                              ...
                              <?php
                                ...
                                $mail=$_SESSION['email'];
                                $result=mysqli_query($conn,"SELECT `name` from `seller` where `email`='$mail'");
    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                <h6>The Best Platform to Sell Your Vehicle</h6>
